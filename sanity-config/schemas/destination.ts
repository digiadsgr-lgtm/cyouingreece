...
export const destinationSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'youtube_video_url', type: 'url', title: 'Main YouTube Video URL',
      description: 'The cinematic or main documentary YouTube video for the Hero or Media section',
      group: 'media',
    }),
    defineField({
      name: 'related_videos', type: 'array', title: 'Related YouTube Videos',
      description: 'Extra video links (Walking tours, food guides, etc.)',
